...
#' If \code{env} is a memory address, the memory address itself is searched for among the defined environments 
...
#' \itemize{
#' \item{\code{pathname}} the environment name with the full path to reach it separated by \code{$}
#' (e.g. env1$env$envx)
#' \item{\code{address}} the memory address of the environment given in \code{pathname}
#' }
...
#' 
#' If \code{env} is not found or it is not an environment, NULL is returned and an appropriate is shown.
#' 
