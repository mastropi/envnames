...
#' In both cases, the result of a call to get_obj_value() on the function's parameter will be the value
...
#' For instance: \code{with(env1, get_obj_value("z"))} returns "z" and \emph{not} the value of variable 'z'
